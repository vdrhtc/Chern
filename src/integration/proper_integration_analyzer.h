...
TwoDimensionalIntNetPoint * get_I_traps_against_N(int, MathFuncPointer, double a, double b);
TwoDimensionalIntNetPoint * get_I_simps_against_N(int, MathFuncPointer, double a, double b);
