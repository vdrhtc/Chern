...
TwoDimensionalIntNetPoint * get_I_traps_against_N(int N_interval, MathFuncPointer f) {
...
TwoDimensionalIntNetPoint * get_I_simps_against_N(int N_interval, MathFuncPointer f) {
	...
	for (N=1; N<N_interval; N++) {
		...
		point.x = N;
		point.y = simps_integrate_double_density(N, f, 1);
